<template>
    <ElCard :class="{'task__wrap--done':isDone}">
        <template v-if="!isEdit">
            ...
            <div>
                <el-button type="primary" @click="editTask" title="Edit">
                    <el-icon>
                        <Edit/>
                    </el-icon>
                </el-button>
                <el-button type="danger" @click="deleteTask(id)" title="Delete">
                    <el-icon>
                        <Delete/>
                    </el-icon>
                </el-button>
        ...
        <template v-else>
            <form>
                ...
                <ElButton @click="saveTask" :disabled="isDisabled" title="Save">{{ $t('buttons.saveTask') }}</ElButton>
                <ElButton @click="cancelEdit" title="Cancel">{{ $t('buttons.cancel') }}</ElButton>
            </form>
        </template>
    </ElCard>
</template>
